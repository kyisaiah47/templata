...
// Main execution
console.log('Starting blog rebuild process...\n');
...
console.log(`\n✅ Successfully rebuilt ${totalArticles} articles into ${outputPath}`);

// Check for duplicates
console.log('\n🔍 Checking for duplicate article IDs...');
const idMatches = newContent.match(/"id":\s*"([^"]+)"/g);
if (idMatches) {
