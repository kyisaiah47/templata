...
export const freelanceGigEconomyTemplate: GuidanceTemplate = {
  ...
  sections: [
    ...
    },
    {
      ...
      description: 'Develop strategies for finding and attracting your ideal clients',
      order: 4,
      reflectionPrompts: [
        {
    ...
    },
    {
      ...
      description: 'Plan for sustainable business growth and scaling opportunities',
      order: 6,
      reflectionPrompts: [
        {
  ...
  resources: [
    {
      ...
      type: 'guide',
      excerpt: 'Learn how to identify which skills have market value and position them effectively for freelance success.',
      ...
      tags: ['skills', 'market-research', 'monetization', 'competitive-analysis'],
      readTime: '8 min read',
      difficulty: 'beginner'
    },
    {
      ...
      type: 'guide',
      excerpt: 'Essential steps to establish your freelance business legally and protect yourself professionally.',
      ...
      tags: ['business-setup', 'legal', 'contracts', 'insurance', 'taxes'],
      readTime: '12 min read',
      difficulty: 'intermediate'
    },
    {
      ...
      type: 'guide',
      excerpt: 'Master pricing strategies to maximize your freelance income and position yourself competitively.',
      ...
      tags: ['pricing', 'strategy', 'income', 'rates'],
      readTime: '10 min read',
      difficulty: 'intermediate'
    },
    {
      ...
      type: 'guide',
      excerpt: 'Comprehensive strategies for finding and attracting your ideal freelance clients.',
      ...
      tags: ['marketing', 'client-acquisition', 'networking', 'referrals'],
    ...
    },
    {
      ...
      type: 'guide',
      excerpt: 'Strategic approaches to growing your freelance business beyond solo work.',
      ...
      tags: ['scaling', 'growth', 'automation', 'team-building'],
      readTime: '12 min read',
      difficulty: 'expert'
    }
  ],
