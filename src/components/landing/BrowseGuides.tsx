export function BrowseGuides() {
  const guides = [
    ...
    { title: "Wedding Planning", category: "Life Events", questions: 15, readings: 12, color: "indigo" },
        ...
        {guides.map((guide, i) => (
          ...
          >
            <div className="space-y-2">
              <div className={`text-xs font-medium inline-block px-2 py-0.5 rounded ${categoryColors[guide.color]}`} style={guide.color === 'indigo' ? { color: '#6366f1' } : {}}>{guide.category}</div>
