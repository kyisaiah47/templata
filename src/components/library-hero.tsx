...
import { BookOpen, FileText, Lightbulb, GraduationCap, BookMarked, Newspaper, Library, ScrollText } from "lucide-react";
    ...
    <section className="relative py-32 pt-56">
      <div className="container flex flex-col items-center justify-center gap-4 overflow-hidden">
        ...
        <h1 className="realtive z-15 max-w-3xl text-center text-6xl font-medium tracking-tighter md:text-7xl">
          ...
          >
            {"Explore Expert Knowledge".split(" ").map((word, i) => (
              <motion.span
        ...
        >
          <SkiperUiMarquee
            ...
            className=""
            reverse={true}
            icons={[BookOpen, Library, FileText, Newspaper]}
          />
          <SkiperUiMarquee
            showCard={2}
            className=""
            icons={[Lightbulb, GraduationCap, BookMarked, ScrollText]}
          />
          <SkiperUiMarquee
            showCard={3}
            reverse={true}
            className=""
            icons={[BookOpen, FileText, Lightbulb, Library]}
          />
          <SkiperUiMarquee
            showCard={2}
            className=""
            icons={[GraduationCap, Newspaper, BookMarked, ScrollText]}
          />
          <SkiperUiMarquee
            showCard={3}
            reverse={true}
            className=""
            icons={[BookOpen, Library, Lightbulb, FileText]}
          />
          <SkiperUiMarquee
            showCard={2}
            className=""
            icons={[GraduationCap, BookMarked, Newspaper, ScrollText]}
          />
          <SkiperUiMarquee
            reverse={true}
            showCard={1}
            className=""
            icons={[Library, FileText, Lightbulb, BookOpen]}
          />
        </motion.div>
