...
const templateOfWeekHistory: TemplateOfWeek[] = [
  {
    ...
    curator: {
      name: "Sarah Johnson",
      role: "Certified Wedding Planner",
      quote: "This template captures comprehensive wedding planning guidance generated by the Codex Engine. It's the systematic approach every couple needs."
    }
  },
  {
    ...
    curator: {
      ...
      quote: "Home buying is the largest financial decision most people make. This template ensures they make it confidently and successfully."
    }
  },
  {
    ...
    curator: {
      ...
      quote: "This template addresses both the practical and emotional aspects of preparing for a baby. It's comprehensive yet accessible."
    }
  }
]
